...
# Caminho para salvar os dados no diretório models/
BASE_DIR = os.path.dirname(__file__)
SAVE_PATH = os.path.abspath(os.path.join(BASE_DIR, "..", "models", "dados_libras.pkl"))
...
while True:
    ...
    # Se ESC pressionado sem detecção de mão
